      ...
      test_suites:
        export_dicts:
          properties:
            ...
            date: '2024-05-25T18:17:27Z'
            failed: false
            job_link: '[test job link](https://infracicdd1s1.example.org/jenkins/job/INFRA/job/repo-test-automation/job/dettonville.ci/job/run-module-tests/job/develop-lj/949/)'
          test_cases:
            '01':
              properties:
                collection_version: 2024.5.3
...
try:
    ...
    try:
        ...
        from ansible_collections.dettonville.ci.plugins.module_utils.test_results_logger import TestResultsLogger
