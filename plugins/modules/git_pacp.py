...
try:
    ...
    try:
        ...
        from ansible_collections.dettonville.ci.plugins.module_utils.git_actions import Git
...
try:
    ...
    try:
        ...
        from ansible_collections.dettonville.ci.plugins.module_utils.git_configuration import GitConfiguration
